...
export const componentMap = {
  ...
  ComponentContactForm: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-contact-form/ctf-contact-form').then(
      module => module.CtfContactForm,
    ),
  ),
  ComponentHelpSection: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-help-section/ctf-help-section').then(
      module => module.CtfHelpSection,
    ),
  ),
  ComponentContactPage: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-contact-page/ctf-contact-page').then(
      module => module.CtfContactPage,
    ),
  ),
};
...
export const componentGqlMap = {
  ...
  ComponentContactForm: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-contact-form/ctf-contact-form-gql').then(
      module => module.CtfContactFormGql,
    ),
  ),
  ComponentHelpSection: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-help-section/ctf-help-section-gql').then(
      module => module.CtfHelpSectionGql,
    ),
  ),
  ComponentContactPage: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-contact-page/ctf-contact-page-gql').then(
      module => module.CtfContactPageGql,
    ),
  ),
};
